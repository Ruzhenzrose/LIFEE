...
var INITIAL_PERSONAS = [
    ...
    // Hidden from the carousel by default (no DOMAIN_MAP entry, no matching category).
    {
        ...
        avatar: '/void/assets/personas/seal-master.png',
        cover_url: '/void/assets/personas/seal-master.png',
        cover_fit: 'cover',
        cover_position: '50% 50%',
    ...
    },
    {
        ...
        avatar: '/void/assets/personas/tarot-reader.png',
        cover_url: '/void/assets/personas/tarot-reader.png',
        cover_fit: 'cover',
        cover_position: '50% 50%',
