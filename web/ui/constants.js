...
var INITIAL_PERSONAS = [
    ...
    // Hidden from the carousel by default (no DOMAIN_MAP entry, no matching category).
    {
        ...
        avatar: '/void/assets/personas/seal-master.svg',
        cover_url: '/void/assets/personas/seal-master.svg',
        cover_fit: 'cover',
        cover_position: '50% 50%',
    ...
    },
    {
        ...
        avatar: '/void/assets/personas/tarot-reader.svg',
        cover_url: '/void/assets/personas/tarot-reader.svg',
        cover_fit: 'cover',
        cover_position: '50% 50%',
